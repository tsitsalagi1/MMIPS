export default function PrivacyPage() {
  return (
    <main className="container section legal-body">
      ...
      <p>Not all submitted information is public. MMIPS may keep submitter contact information, private notes, sensitive locations, and review records private. Public case pages should contain only reviewed information intended for public awareness.</p>
