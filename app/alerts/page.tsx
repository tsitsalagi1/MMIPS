  ...
  return (
    <main className="container section">
      ...
      <form className="card form">
        ...
        <label className="checkbox"><input type="checkbox" /> I agree to receive MMIPS alerts for verified, family-approved or agency-supported cases in my selected area.</label>
