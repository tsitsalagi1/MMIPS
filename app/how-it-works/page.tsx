  ...
  return (
    <main className="container section legal-body">
      ...
      <p className="lead">
        ...
        authorized advocates, Tribal representatives, and official contacts share reviewed case information
      ...
      <section className="feature-grid">
        <div className="card">
          ...
          <p>Submitted cases go into a private review queue. They do not become public automatically.</p>
        </div>
        <div className="card">
        ...
        <div className="card">
          ...
          <p>Only approved public fields appear on case pages. Private submitter information, internal notes, and unsafe details stay private.</p>
        </div>
        <div className="card">
          <h2>4. Correct or remove</h2>
          <p>Families and authorized contacts can ask MMIPS to correct, hide, or remove public case information.</p>
        </div>
      </section>
      ...
      <h2>What happens after a case is submitted?</h2>
      <ol>
        <li>The case is saved privately for review.</li>
        <li>An admin reviews safety, consent, public-source support, and contact information.</li>
        <li>The admin may approve, reject, request more information, or keep the case hidden.</li>
        <li>If approved, MMIPS creates a public case page with limited, reviewed public information.</li>
      </ol>
