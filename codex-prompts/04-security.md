# Security, RLS, and Storage Audit Prompt

Branch/workspace: `codex/security-audit`

## Scope

Audit and harden Supabase RLS, storage policies, admin authorization, Turnstile enforcement, environment-variable usage, logging, file-upload security, and migration order.
...
Start in Wave 1 and cross-review alerts-v1 and map-v1 before merge. Do not access production credentials or live private data.
