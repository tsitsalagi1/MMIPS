...
create trigger submissions_private_rate_limit_guard before insert on public.submissions for each row execute function private.mmips_submission_write_guard();

drop trigger if exists corrections_private_rate_limit_guard on public.correction_requests;
create trigger corrections_private_rate_limit_guard before insert on public.correction_requests for each row execute function private.mmips_correction_write_guard();
